    ...
    integrity="sha256-kmHvs0B+OpCW5GVHUNjv9rOmY0IvSIRcf7zGUDTDQM8=" crossorigin="anonymous"></script>
        ...
        <style>
            ...
            header.masthead:before {
                background: url("assets/img/<?php echo 'banner-rio-cuarto.png';?>") no-repeat center center;
                content: "";
                position: absolute;
                height: 100%;
                width: 100%;
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-text px-md-5">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link pagActual" aria-current="page" href="index.php">Inicio</a>
                            </li>
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 order-md-2 order-1 my-auto showcase-text">
                        <h2>Bienvenid@!</h2>
                        <p class="lead mb-0">Sitio Web de la Municipalidad de Río Cuarto, Cantón número 82 del país</p>
                    </div>
                </div>
            </div>
        </section>
