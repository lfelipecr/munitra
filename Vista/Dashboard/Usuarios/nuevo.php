        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div class="row mt-3">
            ...
            <div class="col-12">
              ...
              <input type="number" class="form-control mb-3" name="propiedadFuera" id="txtPropiedadFuera">
            </div>
            <div class="col-12">
              <span class="mb-3">Consentimiento</span>
              <input type="checkbox" id="cbxConsentimiento">
            ...
            <div class="row p-none formUsuario">
              ...
              <div class="col-12">
                ...
                <input type="checkbox" id="cbxResponsable">
