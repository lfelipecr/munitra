<main class="col-sm-10 bg-body-tertiary" id="main">
  <div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="title">
      <h1 class="h2">Solicitudes de Visado</h1>
      ...
      <a href="index.php?controlador=Visado&metodo=VIngresar" class="btn btn-outline-primary">
        <span>Agregar +</span>
      </a>
    </div>
    <input type="hidden" id="jsonData" value='<?php echo $jsonData; ?>'>
    <input type="hidden" id="controlador" value="Visado">
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col" class="text-end"><svg style="width: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
          ...
          <tbody id="tbodyListadoPersonas"></tbody>
        </table>
      </div>
    </div>
  </div>
