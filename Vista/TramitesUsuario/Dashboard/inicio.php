        ...
        <div class="row">
            ...
            <div class="col-12 mb-3 col-md-4">
                <div class="card p-5 cardOpciones" onclick="window.location.href = 'index.php?controlador=Tramites&metodo=ListadoTramites';">
                    <span><svg style="width: 3em;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
