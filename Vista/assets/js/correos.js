            ...
            if (response != ''){
                ...
                for (let i = 0; i < chat.length; i++){
                    ...
                    if (chat[i][2] != ''){
                        ...
                        listado += `<button class="btn btn-outline-warning mx-1 mt-md-none mb-1 mt-1" data-bs-toggle="modal" data-bs-target="#modalDocs" onclick='Adjuntos(${JSON.stringify(adjuntos).replace(/"/g, '&quot;')})'>
