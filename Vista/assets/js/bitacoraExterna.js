            ...
            if (response == ''){
                ...
                for (let i = 0; i < jsonData.length; i++){
                    ...
                    if (jsonData[i][14] != ''){
                        ...
                        html += `<a class="btn btn-outline-warning mx-1 mt-md-none mb-1 mt-1" data-bs-toggle="modal" data-bs-target="#modalDocs" onclick='Adjuntos(${JSON.stringify(adjuntos).replace(/"/g, '&quot;')})'>
