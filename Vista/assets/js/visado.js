$(document).ready(function () {
      ...
      for (let i = 0; i < datos.length; i++) {
        switch (datos[i][4]) {
          ...
          case "26":
            ...
            $("#requisitosEmbed").html(
              $("#requisitosEmbed").html() +
                `<span class="mb-3 embedTxt">Carta de Disponibilidad:</span><embed src="${datos[i][1]}" type="application/pdf" width="100%" height="500px">`
            );
            break;
          case "27":
            ...
            $("#requisitosEmbed").html(
              $("#requisitosEmbed").html() +
                `<span class="mb-3 embedTxt">Croquis:</span><embed src="${datos[i][1]}" type="application/pdf" width="100%" height="500px">`
            );
            break;
          case "28":
            ...
            $("#requisitosEmbed").html(
              $("#requisitosEmbed").html() +
                `<span class="mb-3 embedTxt">Plano Corregido:</span><embed src="${datos[i][1]}" type="application/pdf" width="100%" height="500px">`
            );
            break;
          case "29":
            ...
            $("#requisitosEmbed").html(
              $("#requisitosEmbed").html() +
                `<span class="mb-3 embedTxt">Copia de la Minuta:</span><embed src="${datos[i][1]}" type="application/pdf" width="100%" height="500px">`
            );
            break;
          case "30":
            ...
            $("#requisitosEmbed").html(
              $("#requisitosEmbed").html() +
                `<span class="mb-3 embedTxt"> Carta de certificación MOPT:</span><embed src="${datos[i][1]}" type="application/pdf" width="100%" height="500px">`
            );
            break;
          case "31":
  ...
  $("#frmVisado").on("submit", function () {
    ...
    if (
      $("#direccionPropiedad").val().trim() == "" ||
      $("#numeroPlano").val().trim() == "" ||
      $("#areaPlano").val().trim() == "" ||
      $("#numeroFinca").val().trim() == "" ||
      $("#areaRegistroPublico").val().trim() == "" ||
      $("#frente").val().trim() == "" ||
      $("#numeroContrato").val().trim() == ""
    ) {
      $("#alerta").html(
