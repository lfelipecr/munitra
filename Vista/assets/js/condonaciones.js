$(document).ready(function () {
        ...
        switch (datos[i][4]) {
          ...
          case "36":
            ...
            if (datos[i][1] == "Pago de contado") {
              html =
                '<option selected="" value="Pago de contado" id="contadoOpcion">Pago de contado</option><option value="Arreglo de pago" id="arregloOpcion">Arreglo de pago</option>';
            } else {
              html =
                '<option value="Pago de contado" id="contadoOpcion">Pago de contado</option><option value="Arreglo de pago" selected="" id="arregloOpcion">Arreglo de pago</option>';
            }
          ...
          case "52":
            ...
            if (datos[i][1] == "Prevención") {
              html =
                '<option value="Aprobación">Aprobación</option><option value="Denegatoria">Denegatoria</option><option selected value="Prevención" id="opcionPrevencion">Prevención</option>';
            } else if (datos[i][1] == "Denegatoria") {
              html =
                '<option value="Aprobación">Aprobación</option><option selected value="Denegatoria">Denegatoria</option><option value="Prevención" id="opcionPrevencion">Prevención</option>';
            } else {
              html =
                '<option selected value="Aprobación">Aprobación</option><option value="Denegatoria">Denegatoria</option><option value="Prevención" id="opcionPrevencion">Prevención</option>';
            }
  ...
  $("#frmCondonacion").on("submit", function () {
    ...
    //datos obligatorios
    if (
      $("#txtRepresentante").val().trim() == "" ||
      $("#txtIdentificacionRepresentante").val().trim() == "" ||
      $("#txtDireccion").val().trim() == "" ||
      $("#txtRecibido").val().trim() == ""
    ) {
      $("#alerta").html(
